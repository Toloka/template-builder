const freezePath = 'https://tlkfrontprod.azureedge.net/template-builder-production/launcher.embed/';
...
module.exports = (env = {}, options) =>
    merge(common(env, options), {
        ...
        entry: {
            embed: path.resolve(__dirname, 'launcher.embed.ts')
        },
        output: {
        ...
        plugins: [
            ...
            new HtmlWebpackPlugin({
                title: 'Template',
                template: `${__dirname}/launcher.embed.html`
            })
        ].concat(
