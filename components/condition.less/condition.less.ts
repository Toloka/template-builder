...
import translations from './i18n/condition.less.translations';

export type ConditionLessProps = {
    data: number;
    then: number;
    orEquals?: true;
};

const type = 'condition.less';
...
export const create = (core: Core) => {
    ...
    return {
        type,
        compile: core.helpers.conditionV2<ConditionLessProps, keyof typeof translations.ru>(
            type,
            (props) => {
